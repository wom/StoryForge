...
class OpenAIBackend(LLMBackend):
    ...
    - Story model: Defaults to gpt-5.5 (configurable via system.openai_story_model)
    ...
    def generate_video_prompt(
        ...
        """Break the story into scene-by-scene video prompts using OpenAI's text model.
        ...
        """
        try:
            video_prompt_request = self._build_video_prompt_request(
                story, context, num_scenes, character_descriptions=character_descriptions
            )
